...
const ProductCart = ({product}) => {
  ...
  return product && (
    ...
    //Onclick fn over here below in the first div is for navigating to product page when clicked on a product , it may come in handy it is important , learn the sysntax
