...
const SellerLogin = () => {
    ...
    const onSubmitHandler = async(e) => {
        // setIsSeller(true) // to keep the user loged IN even after refresh
        try{
             e.preventDefault();
        ...
        <div className=' flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80 sm:min-w-88 rounded-lg shadow-xl border border-gray-200 ' >
            ...
            <div className=' w-full ' >
                ...
                <input onChange={(e)=>setEmail(e.target.value)} value={email} type="email" name="" id="" placeholder=' Enter your E-mail '
                 className=' border border-gray-200 rounded w-full p-3 mt-1 outline-primary ' required  />
            </div>

            <div className=' w-full ' >
                <p>Password</p>
                <input onChange={(e)=>setPassword(e.target.value)} value={password} type="text" name="" id="" placeholder='Enter passowrd'
